...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input class="form-control" placeholder="${placeholder!}" id="${id}" name="${id}"
               @if(isNotEmpty(value)){
        ...
        @if(isNotEmpty(hidden)){
            <input class="form-control" type="hidden" id="${hidden}" value="${hiddenValue!}" placeholder="${placeholder!}">
        @}
